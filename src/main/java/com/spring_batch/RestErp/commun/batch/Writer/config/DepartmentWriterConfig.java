...
import com.spring_batch.RestErp.commun.batch.Writer.itemWriter.DepartmentItemWriter;
...
public class DepartmentWriterConfig {
    ...
    @Bean
    public ItemWriter<DimDepartment> departmentWriter(
            @Qualifier("dwDataSource") DataSource dwDataSource) {
        return new DepartmentItemWriter(new JdbcTemplate(dwDataSource));
    }
}
